...
void Swapchain::acquire_next_image(VkSemaphore* signal, uint32_t* image_index)
{
    vkAcquireNextImageKHR(*device, swapchain, UINT64_MAX, *signal, VK_NULL_HANDLE, image_index);
}
