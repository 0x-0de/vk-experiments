...
void descriptor::place_data(uint32_t descriptor_set, uint32_t binding_index, void* data)
{
	size_t buffer_index = descriptor_bindings[binding_index].buffer_index;
	alloc::map_data_to_buffer(data, buffers.data() + buffer_index + descriptor_set);
}